...
export function useStartSession() { const qc = useQueryClient(); return useMutation({ mutationFn: (batteryId: string) => api.post<import("../types").ActiveSession>("/api/sessions", { batteryId }), onSuccess: () => { void qc.invalidateQueries({ queryKey: keys.me }); void qc.invalidateQueries({ queryKey: keys.batteries }); void qc.invalidateQueries({ queryKey: keys.dashboard }); } }); }
